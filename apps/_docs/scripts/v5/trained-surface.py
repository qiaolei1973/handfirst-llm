...
ax1.set_title("真实曲面 $f(x_1, x_2)$", fontsize=14)
ax1.set_xlabel("x₁"); ax1.set_ylabel("x₂"); ax1.set_zlabel("y")
ax1.view_init(elev=25, azim=-60)

# 右：模型预测曲面（占位，由 train.ts 输出替换）
ax2 = fig.add_subplot(1, 2, 2, projection="3d")
# 占位：用 train 输出的预测值
ax2.set_title("模型预测曲面 (N 个 ReLU)", fontsize=14)
ax2.set_xlabel("x₁"); ax2.set_ylabel("x₂"); ax2.set_zlabel("ŷ")
